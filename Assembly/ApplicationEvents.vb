...
Namespace My
    ...
    Partial Friend Class MyApplication
        Sub HandlerWhenException(ByVal sender As Object, e As Microsoft.VisualBasic.ApplicationServices.UnhandledExceptionEventArgs) Handles Me.UnhandledException
            '------------------------------------
            '   Error occured when shutdown
            '------------------------------------
            Dim tempLogger As logHandler = New logHandler(".fatal")
            Dim fatalMessage As messagePackageEventArg = New messagePackageEventArg()
            fatalMessage.Message = New messagePackage(Me,
                                                      exceptionEnum.UNHANDLED_ERROR,
